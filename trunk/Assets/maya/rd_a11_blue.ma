...
//Name: rd_a11_blue.ma
//Last modified: Thu, Apr 17, 2014 07:52:58 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -66.54424237788291 356.5588115032881 247.74684927377922 ;
	setAttr ".r" -type "double3" -57.938352729613577 0.1999999999990702 1.9878587866306898e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 456.19563018120721;
...
createNode mesh -n "polySurfaceShape11" -p "transform14";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.34873038701580583 0.38466179036572268 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode polyTweakUV -n "polyTweakUV5";
	setAttr ".uopa" yes;
	setAttr -s 24 ".uvtk[0:23]" -type "float2" -0.01709073 -0.11536247 -0.01709073
		 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247
		 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073
		 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247
		 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073
		 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247
		 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073 -0.11536247 -0.01709073
		 -0.11536247 -0.01709073 -0.11536247;
